...
const COURSES: CourseItem[] = [
  ...
  },
  {
    ...
    subtitle: "Full Agency System · Community & Live Sessions",
    badge: "🔥 MEMBERSHIP",
    badgeTone: "volt",
    originalPrice: "$250/Mo",
    currentPrice: "$159",
    priceNote: "$159 per month instead of $250/Mo · cancel anytime · instant access",
    description:
      "Build a working AI Lead Management System, package it as a service, and run real outreach to land your first $2,000 client. Weekly live builds, complete blueprints, and private builders community included.",
    highlights: [
      "Weekly live build sessions & direct feedback",
      "Private 1:1 onboarding & pipeline review",
      "Six vertical prompt libraries used commercially by Devmate",
      "Proposal, pricing sheet, contract & objection-handling scripts",
    ],
    duration: "Continuous · Cancel Anytime",
    level: "Beginner to Advanced",
    icon: DollarSign,
    route: "/aaa-accelerator",
    featured: false,
  },
];
