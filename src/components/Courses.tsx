...
const COURSES: CourseItem[] = [
  {
    ...
    subtitle: "From Zero to Expert AI Engineer & Prompt Architect",
    ...
    description:
      "Master Anthropic's Claude 3.5 Sonnet and modern AI agent design. Build real prompt architectures, production agents, code generation pipelines, and automated business workflows in 7 practical daily sprints.",
    highlights: [
      "7 structured daily engineering sprints",
      "Production-grade prompt architectures & system prompts",
      "Claude Artifacts & API automation workflows",
      "Live templates, sandbox code & final exam certification",
    ],
